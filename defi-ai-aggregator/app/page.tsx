            ...
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-mono text-xl text-teal-400">Trillo</span>
                </div>
              </div>
          ...
          <div className="w-full bg-gradient-to-r from-teal-400/60 to-amber-500/60 border-b border-gray-800">
            <div className="max-w-4xl mx-auto px-4 py-6">
              <div className="flex flex-col items-center mb-4">
                <div className="h-25 w-60 mb-3">
                  <img src="/static/Trillo.svg" alt="Trillo Logo" className="w-full h-full" />
                </div>
                {/* <h1 className="text-3xl font-bold text-white mb-1">Trillo</h1> */}
                <p className="text-lg text-white/90 font-medium mb-3">
                  Unlocking Aptos DeFi, Made AI Simple
                </p>
                <p className="text-gray-100/70 max-w-md mx-auto text-center text-sm">
                  Your AI-powered guide to navigating the Aptos DeFi ecosystem. 
                  Ask about swaps, yields, market analysis, and more.
                </p>
              </div>
